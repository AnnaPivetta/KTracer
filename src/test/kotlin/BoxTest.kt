...
class BoxTest {
    ...
    fun rayIntersection() {
        ...
        val expectedUV1 = Vector2d(0.25F+0.5F/4.0F, 0.5F + 0.5F/4F)
        val expectedT1 = 1.5F
        ...
        val expectedUV2 = Vector2d(0.5F+0.5F/4.0F, 0.5F + 0.5F/4F)
        val expectedT2 = 2.5F
        ...
        val expectedUV3 = Vector2d(0.5F/4.0F, 0.5F + 0.5F/4F)
        val expectedT3 = 0.5F
